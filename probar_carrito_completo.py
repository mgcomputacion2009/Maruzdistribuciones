...
# -*- coding: utf-8 -*-
"""
Script de prueba completa del sistema de carrito
...
def test_carrito_completo():
    """Probar el flujo completo del carrito"""
    
    # URL base del servidor
    base_url = "http://localhost:8002"
    
    print("🚀 INICIANDO PRUEBA COMPLETA DEL SISTEMA DE CARRITO")
    print("=" * 70)
    ...
    try:
        response = requests.get(f"{base_url}/api/carrito/productos")
        data = response.json()
    ...
    datos_compra = {
        ...
        "cliente_telefono": "555-9876",
        "cliente_email": "maria.test@example.com",
        "direccion_entrega": "Av. Principal 456, Col. Centro, CP 54321",
        "metodo_pago": "transferencia",
        "notas": "Prueba completa del sistema de carrito - Entrega en horario de oficina"
    }
