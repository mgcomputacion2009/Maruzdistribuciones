...
def create_app():
    ...
    # Registrar el blueprint del carrito de compras
    from app.maruz_distribuciones.api.carrito import carrito_bp
    app.register_blueprint(carrito_bp, name='carrito')
    
    # Registrar el blueprint del sistema de pedido abierto
    from app.maruz_distribuciones.api.pedido import pedido_bp
    app.register_blueprint(pedido_bp, name='pedido')
